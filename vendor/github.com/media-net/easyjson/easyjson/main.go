...
import (
	...
	"github.com/media-net/easyjson/bootstrap"
	...
	_ "github.com/media-net/easyjson/gen"
	"github.com/media-net/easyjson/parser"
)

var buildTags = flag.String("build_tags", "", "build tags to add to generated file test")
